...
\begin{abstract}
   Recently, the application of deep reinforcement learning to game environments has attracted attention. In particular, the game with imperfect information has been paid attention to in this field.
