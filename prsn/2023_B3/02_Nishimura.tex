...
\begin{table}[t]
  ...
  また, 4 コストの ID 4 のカードが 3 コストの ID 14 に比べて多くプレイされている. ID 4 のカードは HP が唯一 4 となるカードであり対戦相手は, Algorithm \ref{alg1} に従うため, 対戦相手は ID 3, 4 のカードを盤面に出さなければ ID 4 のカードは破壊されることがない. また攻撃力も 5 と全カード中最大であるため本実験条件においてはカードパワーが高いカードである. 一方で, ID 14 のカードは 3 コストのカードの中で攻撃力と HP の和が最も低く, 特殊効果も治癒であるため相手プレイヤーの HP をなるべく早く減らすといった戦略とは親和性が低い. そのため ID 14 のカードを盤面にプレイするよりも, コストが 1 高いが強力な ID 4 のカードを盤面に出すことが得であると学習している. すなわち構築した戦略において各カードの強弱も学習しているといえる. 
  ...
  \begin{table}[t]
    ...
    \scalebox{0.70}[0.60]{
      \begin{tabular}{|ll|ll|}
        ...
        \multicolumn{1}{|l|}{0}  & 60624 & \multicolumn{1}{l|}{0}  & 42462 \\ \hline
        \multicolumn{1}{|l|}{1}  & 59675 & \multicolumn{1}{l|}{1} & 40223 \\ \hline
        \multicolumn{1}{|l|}{9}  & 59310 & \multicolumn{1}{l|}{13}  & 40129 \\ \hline
        \multicolumn{1}{|l|}{11} & 59198 & \multicolumn{1}{l|}{7}  & 39376 \\ \hline
        \multicolumn{1}{|l|}{13} & 58762 & \multicolumn{1}{l|}{11} & 38578 \\ \hline
        \multicolumn{1}{|l|}{2}  & 58075 & \multicolumn{1}{l|}{9}  & 38402 \\ \hline
        \multicolumn{1}{|l|}{5}  & 57498 & \multicolumn{1}{l|}{5}  & 38112 \\ \hline
        \multicolumn{1}{|l|}{10}  & 57288 & \multicolumn{1}{l|}{2}  & 38019 \\ \hline
        \multicolumn{1}{|l|}{7} & 57204 & \multicolumn{1}{l|}{8}  & 37703 \\ \hline
        \multicolumn{1}{|l|}{12} & 56148 & \multicolumn{1}{l|}{3}  & 34682 \\ \hline
        \multicolumn{1}{|l|}{8}  & 55872 & \multicolumn{1}{l|}{12} & 34296 \\ \hline
        \multicolumn{1}{|l|}{14}  & 55167 & \multicolumn{1}{l|}{10}  & 33971 \\ \hline
        \multicolumn{1}{|l|}{3} & 55079 & \multicolumn{1}{l|}{6}  & 33840 \\ \hline
        \multicolumn{1}{|l|}{6}  & 53809 & \multicolumn{1}{l|}{4} & 33778 \\ \hline
        \multicolumn{1}{|l|}{4}  & 53745 & \multicolumn{1}{l|}{14} & 32522 \\ \hline
        \end{tabular}
    }
    \end{table}
