...
class RandomPlayer2:
            ...
            if action != 5:
                if len(self.enemy.is_played) > enemy_num and len(self.is_played) > 0:
                    ...
                    if self.is_played[0].is_used == False:
                        #if self.is_played[0].id != 15 and self.action_count_dict[self.is_played[0].id] == 0:
                        #    self.action_count_dict[self.is_played[0].id] += 1
            ...
            if action != 5:
                if len(self.enemy.is_played) > enemy_num and len(self.is_played) > 1:
                    ...
                    if self.is_played[1].is_used == False:
                        #if self.is_played[1].id != 15 and self.action_count_dict[self.is_played[1].id] == 0:
                        #    self.action_count_dict[self.is_played[1].id] += 1
            ...
            if action != 5:
                if len(self.enemy.is_played) > enemy_num and len(self.is_played) > 2:
                    ...
                    if self.is_played[2].is_used == False:
                        #if self.is_played[2].id != 15 and self.action_count_dict[self.is_played[2].id] == 0:
                        #    self.action_count_dict[self.is_played[2].id] += 1
            ...
            if action != 5:
                if len(self.enemy.is_played) > enemy_num and len(self.is_played) > 3:
                    ...
                    if self.is_played[3].is_used == False:
                        #if self.is_played[3].id != 15 and self.action_count_dict[self.is_played[3].id] == 0:
                        #    self.action_count_dict[self.is_played[3].id] += 1
            ...
            if action != 5:
                if len(self.enemy.is_played) > enemy_num and len(self.is_played) > 4:
                    ...
                    if self.is_played[4].is_used == False:
                        #if self.is_played[4].id != 15 and self.action_count_dict[self.is_played[4].id] == 0:
                        #    self.action_count_dict[self.is_played[4].id] += 1
    ...
    def generate_dict_action(self):
        self.action_count_dict = {card.id: 0 for card in self.deck}

    def get_action_record(self):
        self.action_count_dict = sorted(self.action_count_dict.items())
        return self.action_count_dict
